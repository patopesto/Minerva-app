...
from api import configure, create_app, start
...
def _config_logging():
	for logger in "gunicorn","gunicorn.access","gunicorn.error":
...
if __name__ == "__main__":
	...
	opts = {
		...
		"max_requests_jitter": settings.get("MAX_REQUESTS_FILTER"),
		"timeout": settings.get("WORKER_TIMEOUT"),
